...
double PrepAndFillEvent(MyEvent *myevent, MyGrid *mygrid, double w, double x1, double x2, double id1, double id2, double xsec=0) {
 ...
 {// loop over events
  ...
  if (iorder==2) {
   ...
   if (t.nuwgt==0) {
    ...
    //what are the pids?
    //wgt = PrepAndFillEvent(myevent, mygrid, w[0], t.x1, t.x2, (t.id1==21? 0:t.id1), (t.id2==21? 0:t.id2) );
    ...
    if (wnz==true) {
     ...
     if ( id1 != GLUON ) {
      ...
      //
       ...
       wgt = PrepAndFillEvent(myevent, mygrid, w[1], t.x1, t.x2, (t.id1==21? 0:t.id1), (t.id2==21? 0:t.id2) );
       myevent->SetWeight( wgt );
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fb*faq*w[1] ); 
       ...
       wgt = PrepAndFillEvent(myevent, mygrid, w[2], (t.x1/1.x1p), t.x2, (t.id1==21? 0:t.id1), (t.id2==21? 0:t.id2) );
       wgt = wgt * ( 1.0 / t.x1p );
       myevent->SetWeight( wgt );
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fb*faqx*w[2]);
       ...
       //term with first parton is gluon
       wgt = PrepAndFillEvent(myevent, mygrid, w[3], t.x1, t.x2, 0, (t.id2==21? 0:t.id2) );
       myevent->SetWeight( wgt );			
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fb*fag*w[3] );
       ...
       //term with first parton is gluon
       wgt = PrepAndFillEvent(myevent, mygrid, w[3], (t.x1/t.x1p), t.x2, 0, (t.id2==21? 0:t.id2) );
       wgt = wgt * ( 1.0 / t.x1p );
       myevent->SetWeight( wgt );
	 ...
	 if ( iflav != GLUON ) {
	   ...
	   if ( currentSubProc != -1 ) {
	     ...
	     wgt = PrepAndFillEvent(myevent, mygrid, w[1], t.x1, t.x2, (iflav-5), (t.id2==21? 0:t.id2) );
	     wgt = wgt * ( 1.0 / nSubCount[currentSubProc] );
	     myevent->SetWeight( wgt );
	 ...
	 if ( iflav != GLUON ) {
	   ...
	   if ( currentSubProc != -1 ) {
	     ...
	     wgt = PrepAndFillEvent(myevent, mygrid, w[2], (t.x1/t.x1p), t.x2, (iflav-6), (t.id2==21? 0:t.id2) );
	     wgt = wgt * ( 1.0 / t.x1p );
	     myevent->SetWeight( wgt );	     
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fb*fag*w[3] );
       ...
       //id1=glu
       wgt = PrepAndFillEvent(myevent, mygrid, w[4], (t.x1/t.x1p), t.x2, 0, (t.id2==21? 0:t.id2) );
       wgt = wgt * ( 1.0 * t.x1p );
       myevent->SetWeight( wgt );
     ...
     if ( id2 != GLUON ) {
       ...
       wgt = PrepAndFillEvent(myevent, mygrid, w[5], t.x1, t.x2, (t.id1==21? 0:t.id1), (t.id2==21? 0:t.id2) );
       myevent->SetWeight( wgt );
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fa*fbq*w[5] );
       ...
       wgt = PrepAndFillEvent(myevent, mygrid, w[6], t.x1, (t.x2/t.x2p), (t.id1==21? 0:t.id1), (t.id2==21? 0:t.id2) );
       wgt = wgt * ( 1.0 / t.x2p );
       myevent->SetWeight( wgt );
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fa*fbqx*w[6] );
       ...
       //id2=glu
       wgt = PrepAndFillEvent(myevent, mygrid, w[7], t.x1, t.x2, (t.id1==21? 0:t.id1), 0 );
       myevent->SetWeight( wgt );
	 ...
	 for ( int igrid=0 ; igrid<NGrid ; igrid++ ) htest3[igrid]->Fill( obs, fa*fbg*w[7] );
       ...
       wgt = PrepAndFillEvent(myevent, mygrid, w[8], t.x1, (t.x2/t.x2p), (t.id1==21? 0:t.id1), 0 );
       wgt = wgt * ( 1.0 * t.x2p );
       myevent->SetWeight( wgt );
	 ...
	 if ( iflav != GLUON ) {
	   ...
	   if ( currentSubProc != -1 ) {
	     ...
	     wgt = PrepAndFillEvent(myevent, mygrid, w[5], t.x1, t.x2, (t.id1==21? 0:t.id1), (iflav-6) );
	     wgt = wgt * ( 1.0 / nSubCount[currentSubProc] );
	     myevent->SetWeight( wgt );
	 ...
	 if ( iflav != GLUON ) {
	   ...
	   if ( currentSubProc != -1 ) {  
	     wgt = PrepAndFillEvent(myevent, mygrid, w[6], t.x1, (t.x2/t.2xp), (t.id1==21? 0:t.id1), (iflav-6) );
	     wgt = wgt * ( 1.0 / t.x2p );
	     myevent->SetWeight( wgt );
